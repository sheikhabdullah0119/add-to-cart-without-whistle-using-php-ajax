                ...
                foreach ($_SESSION['cart_item'] as $item) {
                    ...
                    <tr>
                        <td class="text-left">
                            ...
                            <img src="https://www.geo.tv/assets/uploads/updates/2021-02-10/334361_2245838_updates.jpg" class="img-fluid" width="100">
                            <?= $item['name'] ?>
                        </td>
                            ...
                            <form action="index.php?action=add&pid=<?= $row['id']; ?>" method="post">
                                <div class="card" style="width:18rem">
                                    <img class="card-img-top"
                                         src="https://www.geo.tv/assets/uploads/updates/2021-02-10/334361_2245838_updates.jpg"
                                         alt="<?= $row['name']; ?>"
                                         width="150">
